...
<Tabs defaultValue="npm" className="mb-6">
  ...
  <TabsContent value="pnpm">
    ```bash # Quick start with pnpm pnpm dlx gition@latest # Or run in a
    specific directory pnpm dlx gition@latest ./my-docs ```
  </TabsContent>

  <TabsContent value="yarn">
    ```bash # Quick start with yarn yarn dlx gition@latest # Or run in a
    specific directory yarn dlx gition@latest ./my-docs ```
  </TabsContent>
